        ...
        return (
          <div key={detail.id}>
            <div className="details">
              <img src={detail.image.url} alt="character image" width="20%" />
              <br />
              <div className="intro">
                <Text type="success">Full-Name : &nbsp; &nbsp;</Text>{" "}
                {detail.name}
                <br />
                <Text type="success">gender : </Text> &nbsp; &nbsp;{" "}
                {detail.appearance.gender}
                <br />
                <Text type="success">Height : </Text> &nbsp; &nbsp;
                {detail.appearance.height[1]}
                <br />
                <Text type="success">Weight : </Text> &nbsp; &nbsp;
                {detail.appearance.weight[1]} <br />
                <Text type="success">Publisher : </Text> &nbsp; &nbsp;
                {detail.biography.publisher} <br />
                <br />
                <h2>
                  <Text type="success">Description:-</Text>
                </h2>
                <p>
                  I am {detail.name} and my relations are{" "}
                  {detail.connections.relatives} and my powerstats are listed{" "}
                </p>
                <ul>
