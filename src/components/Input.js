...
import { Layout, Menu, Input, Button, Carousel } from "antd";
          ...
          <div className="site-layout-background" /* style={{ padding: 10 }} */>
            ...
            <div className="carousel">
              <Carousel autoplay>
                ...
                <div>
                  <img
                    src="https://4.bp.blogspot.com/-q0qBWEzC_h4/XJEMRniTyFI/AAAAAAAAA4s/OrCgpTcYHKk2IHJjVlHBHiot_PFclkH4ACKgBGAs/w4096-h2304-c/superman-uhdpaper.com-4K-106.jpg"
                    alt="superman"
                    width="100%"
                    height="400"
                  />
                ...
                <div>
                  <img
                    src="https://cdn.wallpapersafari.com/51/29/vZmCDV.jpg"
                    alt="wonder_woman"
                    width="100%"
                    height="400"
                  />
